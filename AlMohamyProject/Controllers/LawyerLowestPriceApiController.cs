...
namespace AlMohamyProject.Controllers
{
    ...
    [ApiController]
    public class LawyerLowestPriceApiController : ControllerBase
    {
        ...
        // GET: api/<LawyerLowestPriceApiController>
        [HttpGet]
        ...
        // GET api/<LawyerLowestPriceApiController>/5
        [HttpGet("{id}")]
        ...
        //    return lawyersTransferData.OrderBy(a=> a.Cost);



        //}

        // POST api/<LawyerLowestPriceApiController>
        [HttpPost]
        ...
        // PUT api/<LawyerLowestPriceApiController>/5
        [HttpPut("{id}")]
        public void Put(int id, [FromBody] string value)
        {
        }

        // DELETE api/<LawyerLowestPriceApiController>/5
        [HttpDelete("{id}")]

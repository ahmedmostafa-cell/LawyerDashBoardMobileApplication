...
namespace AlMohamyProject.Controllers
{
    ...
    [ApiController]
    public class LawyerHighestExperienceApiController : ControllerBase
    {
        ...
        // GET: api/<LawyerHighestExperienceApiController>
        [HttpGet]
        ...
        // GET api/<LawyerHighestExperienceApiController>/5
        [HttpGet("{id}")]
        ...
        //    return lawyersTransferData.OrderByDescending(a => a.YearsOfExperience);



        //}

        // POST api/<LawyerHighestExperienceApiController>
        [HttpPost]
        ...
        // PUT api/<LawyerHighestExperienceApiController>/5
        [HttpPut("{id}")]
        public void Put(int id, [FromBody] string value)
        {
        }

        // DELETE api/<LawyerHighestExperienceApiController>/5
        [HttpDelete("{id}")]

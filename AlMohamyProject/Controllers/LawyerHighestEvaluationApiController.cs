...
namespace AlMohamyProject.Controllers
{
    ...
    [ApiController]
    public class LawyerHighestEvaluationApiController : ControllerBase
    {
        ...
        // GET: api/<LawyerHighestEvaluationApiController>
        [HttpGet]
        ...
        // GET api/<LawyerHighestEvaluationApiController>/5
        [HttpGet("{id}")]
        ...
        //    return lawyersTransferData.OrderByDescending(a=> a.EvaluationNoOfStatrs);



        //}

        // POST api/<LawyerHighestEvaluationApiController>
        [HttpPost]
        ...
        // PUT api/<LawyerHighestEvaluationApiController>/5
        [HttpPut("{id}")]
        public void Put(int id, [FromBody] string value)
        {
        }

        // DELETE api/<LawyerHighestEvaluationApiController>/5
        [HttpDelete("{id}")]

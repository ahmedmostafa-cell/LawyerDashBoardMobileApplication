...
namespace AlMohamyProject.Controllers
{
    ...
    [ApiController]
    public class LawyerLowestEvaluationApiController : ControllerBase
    {
        ...
        // GET: api/<LawyerLowestEvaluationApiController>
        [HttpGet]
        ...
        // GET api/<LawyerLowestEvaluationApiController>/5
        [HttpGet("{id}")]
        ...
        //    return lawyersTransferData.OrderBy(a=> a.EvaluationNoOfStatrs);



        //}

        // POST api/<LawyerLowestEvaluationApiController>
        [HttpPost]
        ...
        // PUT api/<LawyerLowestEvaluationApiController>/5
        [HttpPut("{id}")]
        public void Put(int id, [FromBody] string value)
        {
        }

        // DELETE api/<LawyerLowestEvaluationApiController>/5
        [HttpDelete("{id}")]

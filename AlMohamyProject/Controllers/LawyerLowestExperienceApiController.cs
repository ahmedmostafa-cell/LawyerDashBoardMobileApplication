...
namespace AlMohamyProject.Controllers
{
    ...
    [ApiController]
    public class LawyerLowestExperienceApiController : ControllerBase
    {
        ...
        // GET: api/<LawyerLowestExperienceApiController>
        [HttpGet]
        ...
        // GET api/<LawyerLowestExperienceApiController>/5
        [HttpGet("{id}")]
        ...
        //    return lawyersTransferData.OrderBy(a=> a.YearsOfExperience);



        //}

        // POST api/<LawyerLowestExperienceApiController>
        [HttpPost]
        ...
        // PUT api/<LawyerLowestExperienceApiController>/5
        [HttpPut("{id}")]
        public void Put(int id, [FromBody] string value)
        {
        }

        // DELETE api/<LawyerLowestExperienceApiController>/5
        [HttpDelete("{id}")]

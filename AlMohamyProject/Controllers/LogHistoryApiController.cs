...
namespace AlMohamyProject.Controllers
{
    ...
    public class LogHistoryApiController : ControllerBase
    {
        ...
        public LogHistoryApiController(LogHistoryService LogHistoryService, AlMohamyDbContext context)
        {
            logHistoryService = LogHistoryService;
            ctx = context;
        ...
        {
            List<TbLogHistory> lstLogHistories = logHistoryService.getAll().Where(a=> a.CreatedBy == "المستخدم").ToList();

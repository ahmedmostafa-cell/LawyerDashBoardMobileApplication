...
namespace AlMohamyProject.Controllers
{
    ...
    [ApiController]
    public class LogHistory2ApiController : ControllerBase
    {
        LogHistoryService logHistoryService;
        AlMohamyDbContext ctx;
        public LogHistory2ApiController(LogHistoryService LogHistoryService, AlMohamyDbContext context)
        {
            logHistoryService = LogHistoryService;
            ctx = context;
        ...
        {
            List<TbLogHistory> lstLogHistories = logHistoryService.getAll().Where(a => a.CreatedBy == "المحامي").ToList();

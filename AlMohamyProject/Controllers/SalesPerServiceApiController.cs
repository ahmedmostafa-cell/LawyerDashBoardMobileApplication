...
namespace AlMohamyProject.Controllers
{
    ...
    [ApiController]
    public class SalesPerServiceApiController : ControllerBase
    {
        ...
        // GET: api/<SalesPerServiceApiController>
        [HttpGet]
        ...
        // GET api/<SalesPerServiceApiController>/5
        [HttpGet("{id}")]
        public IEnumerable<TbConsultingEstablish> Get(Guid id)
        {
            List<TbConsultingEstablish> lstLogHistories = consultingEstablishService.getAll().Where(A => A.ServiceId == id).Where(a => a.TheConsultingPaidValue != null || a.CreatedBy != null || a.TheDocumentationPaidValue != null).ToList();
        ...
        public IEnumerable<TbConsultingEstablish> Get(Guid id, string optionDate1, string optionDate2)
        {
            ...
            {
                lstLogHistories = consultingEstablishService.getAll().Where(a => a.TheConsultingPaidValue != null || a.CreatedBy != null || a.TheDocumentationPaidValue != null).Where(A => A.ServiceId == id).ToList();
            }
            else if (id != null && optionDate2 != null && optionDate1 == null)
            {
                lstLogHistories = consultingEstablishService.getAll().Where(a => a.TheConsultingPaidValue != null || a.CreatedBy != null || a.TheDocumentationPaidValue != null).Where(A => A.ServiceId == id).Where(a => a.CreatedDate < DateTime.Parse(optionDate2)).ToList();
            }
            else if (id != null && optionDate2 == null && optionDate1 != null)
            {
                lstLogHistories = consultingEstablishService.getAll().Where(a => a.TheConsultingPaidValue != null || a.CreatedBy != null || a.TheDocumentationPaidValue != null).Where(A => A.ServiceId == id).Where(a => a.CreatedDate > DateTime.Parse(optionDate1)).ToList();
            }
            else if (id == null && optionDate2 == null && optionDate1 == null)
            {
            ...
            {
                lstLogHistories = consultingEstablishService.getAll().Where(a => a.TheConsultingPaidValue != null || a.CreatedBy != null || a.TheDocumentationPaidValue != null).Where(A => A.ServiceId == id).Where(a => a.CreatedDate > DateTime.Parse(optionDate1)).Where(a => a.CreatedDate < DateTime.Parse(optionDate2)).ToList();
            }
        ...
        // POST api/<SalesPerServiceApiController>
        [HttpPost]
        public void Post([FromBody] string value)
        {
        }

        // PUT api/<SalesPerServiceApiController>/5
        [HttpPut("{id}")]
        public void Put(int id, [FromBody] string value)
        {
        }

        // DELETE api/<SalesPerServiceApiController>/5
        [HttpDelete("{id}")]

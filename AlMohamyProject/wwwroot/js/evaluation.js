...
function updateTable1() {
    ...
    fetch(`https://habibaahmedm-002-site10.atempurl.com/api/CustomerEvaluationApi/${option}`)
        .then(response => response.json())
        .then(data => {
            console.log(data);
            const table = document.getElementById("example");
...
function updateTable2() {
    ...
    const option = document.getElementById("customer").value;
    const option2 = document.getElementById("lawyer").value;
    // Make an API call to fetch data based on the selected option //https://habibaahmedm-002-site10.atempurl.com/
    fetch(`https://habibaahmedm-002-site10.atempurl.com/api/CustomerEvaluationApi/${option}/${option2}`)
        .then(response => response.json())
        .then(data => {
            console.log(data);
            const table = document.getElementById("example");

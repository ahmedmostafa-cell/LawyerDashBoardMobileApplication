...
function updateTable() {
    ...
    {
        const option = document.getElementById("employee").value;
        fetch(`https://habibaahmedm-002-site10.atempurl.com/api/LogHistoryApi/${option}`)
...
function updateTableWithoutParameter() {
    ...
    fetch(`https://habibaahmedm-002-site10.atempurl.com/api/LogHistoryApi/`)
        .then(response => response.json())
        .then(data => {
            console.log("ahmed");
            console.log(data);
...
function updateTableDate1() {
    ...
    const option2 = document.getElementById("VisitsNo");
    // Make an API call to fetch data based on the selected option
    fetch(`https://habibaahmedm-002-site10.atempurl.com/api/LogHistoryApi/${option}/${optionDate1}/${optionDate2}`)
        .then(response => response.json())
        .then(data => {
            console.log(data);
            const table = document.getElementById("example1");

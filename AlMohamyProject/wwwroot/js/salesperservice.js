...
function updateTable() {
    ...
    const option = document.getElementById("servicename").value;
    ...
    fetch(`https://habibaahmedm-002-site10.atempurl.com/api/SettingApi/`)
        ...
        .then(data => {
            ...
            {
                fetch(`https://habibaahmedm-002-site10.atempurl.com/api/SalesPerServiceApi/${option}`)
                    .then(response => response.json())
                    .then(data => {
                        console.log(data);
                        ...
                        fetch(`https://habibaahmedm-002-site10.atempurl.com/api/ChargeApi/${option}`)
                            .then(response => response.json())
                            .then(data => {
...
function updateTableWithoutParameter() {
    ...
    fetch(`https://habibaahmedm-002-site10.atempurl.com/api/SettingApi/`)
        ...
        .then(data => {
            ...
            fetch(`https://habibaahmedm-002-site10.atempurl.com/api/SalesPerServiceApi/`)
                .then(response => response.json())
                .then(data => {
                    console.log(data);
                    const table = document.getElementById("example");
...
function updateTableDate1() {
    ...
    fetch(`https://habibaahmedm-002-site10.atempurl.com/api/SettingApi/`)
        ...
        .then(data => {
            ...
            fetch(`https://habibaahmedm-002-site10.atempurl.com/api/SalesPerServiceApi/${option}/${optionDate1}/${optionDate2}`)
                .then(response => response.json())
                .then(data => {
                    console.log(data);
                    const table = document.getElementById("example");
                    ...
                    document.getElementById("applypaypercent").innerText = applypaydeduct.toFixed(2);
                    document.getElementById("appprofitminusegatespercent").innerText = (appprofitminusvat - (madadeduct + mastervisadeduct + applypaydeduct)).toFixed(2);
                    fetch(`https://habibaahmedm-002-site10.atempurl.com/api/ChargeApi/${option}/${optionDate1}/${optionDate2}`)
                        .then(response => response.json())
                        .then(data => {
